...
testName=winSize+'sec_1sSlid_DS_lpf_all_4C_vR'+'_EarNeck7fEntropy'
...
nTrees=100
projectDir='/home/mgoel1/Dropbox/EarBit/Statistical_Datasets/'+testName+'/'
subjects = ['April2Sub1']
...
Fn=0
results=[]
resultsFileName=projectDir+'allModelresults.txt'
resultsFile=open(resultsFileName,'w')

for i in range(len(subjects)):
	resultsFile.write("=================================================================================\n")
        resultsFile.write("All\n")
	...
	joblib.dump(rfc,projectDir+'/models/All.pk1')
