...
subjects=['kareem_1/1','kareem_1/2','Kareem_2','Malcolm_1','malcolm_2','richard_1','richard_2','sarah_1','sarah_2','lu_1','lu_2','lin_1','lin_2','cheng_1','cheng_2','jz_1','angela_1'] 
sID=['kareem_1_1','kareem_1_2','Kareem_2','Malcolm_1','malcolm_2','richard_1','richard_2','sarah_1','sarah_2','lu_1','lu_2','lin_1','lin_2','cheng_1','cheng_2','jz_1','angela_1'] 
...
for i in range(len(subjects)):
	print subjects[i]
	dirPath=projectDir+subjects[i]+'/'+dataSetName+'/UserDependentTraining/'
	testFile=open(genDataSet+sID[i]+'_SeqTestData.txt','w')
	predictFile=open(genDataSet+sID[i]+'_predictResults.txt','w')
...
#load models and test data on it
	clf = joblib.load(genDataSet+'models/All.pk1')
